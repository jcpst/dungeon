...
public class Gremlin extends Monster {
	...
	public Gremlin() {
		super("Mogwai", 25, 25, 40, 0,
				"Cute little mogwai.. makes cute noises...", 1, 8);
		this.hourChangesBack = 6;		
	}
	
	public Gremlin(String name, int life, int maxLife, int hitChance, int block,
			String description, int minDamage, int maxDamage, int hourChangesBack) {
