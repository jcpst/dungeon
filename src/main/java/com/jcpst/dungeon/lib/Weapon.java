...
public class Weapon {
    ...
    public Weapon(int bonusHitChance, boolean slow, String name, int minDamage, int maxDamage) {
    ...
    public String toString() {
        return String.format("%s\t%d to %d Damage\nBonus Hit: %d\tIs slow? %s", this.name, this.minDamage,
                this.maxDamage, this.bonusHitChance, this.slow);
    }
